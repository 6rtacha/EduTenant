-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'INSTRUCTOR', 'PARENT', 'STUDENT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Enrollment_tenantId_userId_classId_key" ON "Enrollment"("tenantId", "userId", "classId");
